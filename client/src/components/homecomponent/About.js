                ...
                <div className="container my-5 py-5">
                    <div className="row">
                        <div className="col-md-6">
                            <img src={Aboutlogs} alt="About" id='abtimg' className="w-75 mt-5" />
                        </div>
                        <div className="col-md-6">
                            ...
                            <button className="btn btn-primary rounded-pill px-4 py-2" onClick={() => push('/services') }>Get Started</button>
