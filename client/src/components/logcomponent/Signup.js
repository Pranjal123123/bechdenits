   ...
   <>
     <div className="container shadow my-5">
        <div className="row justify-content-end">
          <div id="loginimg" className="col me-5 mt-5 d-flex flex-column align-items-center text-white justify-content-center order-2">
            <h1 id="headlog" className="display-4 fw-bolder">Hello, Friend</h1>
            <p className="lead text-center fw-bolder">Enter Your Details to Register</p>
